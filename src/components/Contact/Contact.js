...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_ok2yolx', 'template_xpannjs', form.current, 'D63jMqhWIMEpfEwwd')
            .then((result) => {
                alert('Message sent')
            }, (error) => {
                alert(error.message);
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form ref={form} onSubmit={sendEmail} class="space-y-8">
                    ...
                    <button type="submit" class="btn btn-outline btn-secondary">Send message</button>
                </form>
            </div>
        </section>
    );
