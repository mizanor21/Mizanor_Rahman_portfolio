...
const Header = () => {
  const onButtonClick = () => {
    fetch("MizanorRahmanResume.pdf").then((response) => {
      ...
      <div className="container mx-auto">
        <div className="lg:flex justify-center items-center py-10 mx-5 md:mx-0">
          <div className="lg:w-1/2">
            ...
            <h3 className="font-serif text-2xl py-5">
              Full-Stack Developer specializing in <br />
              <span title="MongoDB">M</span>
              <span title="ExpressJS">E</span>
              <span title="ReactJS">R</span>
              <span title="NodeJS">N</span> Stack Development
            </h3>
          ...
          <div className="lg:w-1/2">
            ...
            <video
              ...
              src="https://cdnl.iconscout.com/lottie/premium/preview-watermark/web-development-4179004-3479083.mp4"
            ></video>
          </div>
        </div>
